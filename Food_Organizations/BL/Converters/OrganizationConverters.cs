...
namespace BL.Converters
{
    public class OrganizationConverters
    {
        public static Organization GetOrganization(OrganizationDTO organizationDTO)
        {
            ...
            organization.Organizer_Kod = organizationDTO.Organizer_Kod;
        ...
        public static OrganizationDTO GetOrganizationDTO(Organization organization)
        {
            ...
            organizationDTO.Organization_City = organizationDTO.Organization_City;
           
        
            organization.Organization_Describe = organization.Organization_Describe;
            ...
            organizationDTO.Organizer_Kod = organization.Organizer_Kod;
